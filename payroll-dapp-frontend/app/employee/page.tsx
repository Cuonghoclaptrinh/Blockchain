      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
        <div className="max-w-md rounded-2xl border border-amber-100 bg-white px-6 py-8 text-center shadow-sm">
          ...
          <p className="mt-3 text-lg font-bold text-slate-900">
            Vui lòng kết nối ví để tiếp tục chấm công.
          </p>
        </div>
      </div>
    );
      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-10">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-indigo-100/90">
                  Ví: <span className="font-mono">{`${address.slice(
                    0,
                    8,
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Bấm&nbsp;
            <span className="font-semibold text-emerald-600">Check-in</span> khi bắt đầu
            làm, và <span className="font-semibold text-rose-600">Check-out</span> khi
            kết thúc.
          </p>

          {checkInTime ? (
            <div className="mt-5 space-y-4 rounded-xl bg-emerald-50 px-4 py-4 border border-emerald-100">
        ...
        <section className="rounded-2xl bg-white p-6 text-center shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Số tiền bạn có thể rút ngay bây giờ.
          </p>
          ...
          <button
            ...
            className="mt-5 w-full rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:from-indigo-500 hover:to-violet-500 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {Number(accrued) === 0
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Dữ liệu được lấy trực tiếp từ log on-chain.
          </p>
